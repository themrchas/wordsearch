...
$.fn.HillbillyTabs = function (options) {
    ...
    if (CEWPID == "") {
   //crg     CEWPID = $("#tabsContainer").closest("[id^='MSOZoneCell_WebPart']").attr("id");
        CEWPID = $("[id^='MSOZoneCell_WebPart']").attr("id");
    }
...
$.fn.tabby = function tabsTest() {
    console.log('hb tabs is here');
}
